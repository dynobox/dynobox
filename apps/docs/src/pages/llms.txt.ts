...
export async function GET() {
  ...
  const lines = [
    ...
    '- Select a harness: `dynobox run --harness claude-code`, `dynobox run --harness codex`, `dynobox run --harness opencode`, `dynobox run --harness pi`, or `dynobox run --harness cursor`',
