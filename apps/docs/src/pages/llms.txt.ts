...
export async function GET() {
  ...
  const lines = [
    ...
    '- Preview discovered dynos: `dynobox discover [path]`',
    ...
    '- Select a harness: `dynobox run --harness claude-code`, `dynobox run --harness codex`, `dynobox run --harness opencode`, `dynobox run --harness pi`, `dynobox run --harness cursor`, or `dynobox run --harness antigravity`',
